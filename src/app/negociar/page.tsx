...
const BIENVENIDA =
  "Soy el agente de este equipo. Dime qué jugador te interesa y cuánto ofreces. " +
  "Aviso: negocio duro.";
...
export default function NegociarPage() {
    ...
    return (
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-5">
        ...
        <p className="text-muted mt-2 text-[0.9rem]">
          Habla con el agente de este equipo. Dile qué jugador quieres y cuánto ofreces; si llegáis
          a un acuerdo, avisará a su dueño para cerrarlo en el juego.
        </p>
  ...
  return (
    <div className="mx-auto flex h-screen max-w-2xl flex-col px-3 sm:px-5">
      <header className="border-line flex items-center gap-2.5 border-b py-3">
        ...
        <div>
          <div className="font-semibold">Agente de fichajes</div>
